...
>>>>>>> 9613942fec005a43e203afaf352c8564ffcaa2d0:web/streamlit.py
...
coll_name = side_part.selectbox("Choisissez les articles : ", db.list_collection_names()[0:2])
